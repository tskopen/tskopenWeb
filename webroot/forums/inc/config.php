...
$config['database']['database'] = 's370_FORUMS';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'ger3.conquerhost.xyz:3306';
$config['database']['username'] = 'u370_cQWtv03dl0';
$config['database']['password'] = '.A8!^GPK8saLcx4=XMFaoh.P';
